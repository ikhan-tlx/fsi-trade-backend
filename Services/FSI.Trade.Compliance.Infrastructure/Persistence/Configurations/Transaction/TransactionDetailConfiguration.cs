...
{
    public void Configure(EntityTypeBuilder<TransactionDetail> b)
    {
        b.ToTable("TmX_Transaction_Detail", "dbo");
        b.HasKey(x => x.TransactionDetailId);

        b.Property(x => x.TransactionDetailId) .HasColumnName("Transaction_Detail_ID");
