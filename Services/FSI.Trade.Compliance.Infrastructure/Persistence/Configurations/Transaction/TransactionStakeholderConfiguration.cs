...
public class TransactionStakeholderConfiguration : IEntityTypeConfiguration<TransactionStakeholder>
{
    public void Configure(EntityTypeBuilder<TransactionStakeholder> b)
    {
        b.ToTable("TmX_Transaction_Stakeholder", "dbo");
        b.HasKey(x => x.TransactionStakeholderId);

        b.Property(x => x.TransactionStakeholderId) .HasColumnName("Transaction_Stakeholder_Id");
